...
class MuseumCoin(Base):
    ...
    candidates: Mapped[list["CandidateListing"]] = relationship("CandidateListing", back_populates="museum_coin")
...
class CandidateListing(Base):
    ...
    matches: Mapped[list["MatchRecord"]] = relationship("MatchRecord", back_populates="candidate")
...
class MatchRecord(Base):
    ...
    candidate_id: Mapped[str | None] = mapped_column(ForeignKey("candidate_listings.id"), nullable=True)
    ...
    candidate: Mapped[CandidateListing | None] = relationship("CandidateListing", back_populates="matches")
